...
Reads  ./results/gemma_coverage.json
Writes ./results/gemma_coverage_chart.png
"""
...
HOME     = Path.cwd()
IN_FILE  = HOME / "results/gemma_coverage.json"
OUT_FILE = HOME / "results/gemma_coverage_chart.png"
