...
SFT_PATH      = "./models/student/sft_stage2_checkpoint"
DPO_PATH      = "./models/student/dpo_checkpoint"
CAPTIONS_FILE = "./data/generated/all_captions.json"
DPO_PAIRS_FILE= "./data/generated/dpo_pairs.json"
